...
namespace MorrusPOS.Infrastructure.Migrations
{
    ...
    [Migration("20260813154816_AddGenericVariantsAndUMKMFeatures")]
    partial class AddGenericVariantsAndUMKMFeatures
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.AccountTransaction", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "TrxDate");

                    b.HasIndex("BusinessId", "TrxEntity");

                    b.HasIndex("BusinessId", "ReferenceType", "ReferenceId");
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.Business", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OwnerId = new Guid("a4f78de1-8a9d-4e96-857e-399fa5b5f25a"),
                            SelectedPackage = "Development",
                            SubscriptionStatus = "Active",
                            TrialEndDate = new DateTime(2026, 1, 31, 0, 0, 0, 0, DateTimeKind.Utc),
                            TrialStartDate = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            UpdatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });

            modelBuilder.Entity("MorrusPOS.Domain.Entities.CashFlow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("FromChartOfAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ToChartOfAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FromChartOfAccountId");

                    b.HasIndex("OutletId");

                    b.HasIndex("ToChartOfAccountId");

                    b.HasIndex("BusinessId", "TrxDate");

                    b.HasIndex("BusinessId", "TrxNumber")
                        .IsUnique();

                    b.HasIndex("BusinessId", "TrxType");
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.ChartOfAccount", b =>
                {
                    ...
                    b.HasIndex("BusinessId", "AccountCode")
                        .IsUnique();

                    b.HasIndex("BusinessId", "AccountType");

                    b.HasIndex("BusinessId", "IsCashBank");
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.Outlet", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BusinessId = new Guid("11111111-2222-3333-4444-555555555555"),
                            Code = "OUT001",
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
                            Name = "Outlet Utama",
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Code = "account.manage",
                            Description = "Mengelola master chart of accounts"
                        },
                        new
                        {
                            Id = new Guid("eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee"),
                            Code = "cashflow.create",
                            Description = "Membuat transaksi pemasukan dan pengeluaran toko"
                        },
                        new
                        {
                            Id = new Guid("ffffffff-ffff-ffff-ffff-ffffffffffff"),
                            Code = "cashflow.view",
                            Description = "Melihat histori transaksi cash flow manual"
                        },
                        new
                        {
                            Id = new Guid("12121212-1212-1212-1212-121212121212"),
                            Code = "report.cashflow.view",
                            Description = "Melihat laporan arus kas"
                        },
                        new
                        {
                            Id = new Guid("13131313-1313-1313-1313-131313131313"),
                            Code = "report.profitloss_accounting.view",
                            Description = "Melihat laporan laba rugi akuntansi"
                        });
                });
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = new Guid("e1a7b077-44a3-4b63-95e0-59a8501170ea"),
                            PermissionId = new Guid("12121212-1212-1212-1212-121212121212")
                        },
                        new
                        {
                            RoleId = new Guid("e1a7b077-44a3-4b63-95e0-59a8501170ea"),
                            PermissionId = new Guid("13131313-1313-1313-1313-131313131313")
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.AccountTransaction", b =>
                {
                    ...
                    b.HasOne("MorrusPOS.Domain.Entities.ChartOfAccount", "ChartOfAccount")
                        .WithMany("AccountTransactions")
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.CashFlow", b =>
                {
                    ...
                    b.HasOne("MorrusPOS.Domain.Entities.User", "CreatedByUser")
                        .WithMany("CashFlowsCreated")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MorrusPOS.Domain.Entities.ChartOfAccount", "FromChartOfAccount")
                        .WithMany("SourceCashFlows")
                        .HasForeignKey("FromChartOfAccountId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("MorrusPOS.Domain.Entities.ChartOfAccount", "ToChartOfAccount")
                        .WithMany("DestinationCashFlows")
                        .HasForeignKey("ToChartOfAccountId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("FromChartOfAccount");

                    b.Navigation("Outlet");

                    b.Navigation("ToChartOfAccount");
                });
            ...
            modelBuilder.Entity("MorrusPOS.Domain.Entities.ChartOfAccount", b =>
                {
                    ...
                    b.HasOne("MorrusPOS.Domain.Entities.ChartOfAccount", "ParentAccount")
                        .WithMany("Children")
